module SalsaLabs
  ...
  ##
  class SupporterGroups < SalsaObject

    def self.fetch(filter_parameters = {}, credentials = {})
      SupporterGroupsFetcher.new(filter_parameters, credentials).fetch
    end

    def self.tagged(tag, filter_parameters={}, credentials = {})
      SupporterGroupsFetcher.new(filter_parameters).tagged(tag)
    end
  ...
  ##
  class SupporterGroupsFetcher < SalsaObjectsFetcher 
    def initialize(filter_parameters = {}, credentials = {})
      super(filter_parameters, credentials)
      @object_class = SalsaLabs::SupporterGroups
    end
